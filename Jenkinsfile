            ...
            stage('scan with AquaMicroscanner') {
              ...
              stage('scan with Clair') {
                                             steps {
                                               ...
                                               timeout /t 1 &
                                               wget -qO clair-scanner https://github.com/arminc/clair-scanner/releases/download/v12/clair-scanner_windows_386.exe &
                                               ./clair-scanner --ip=172.18.41.161 com.example/rest-service'
                                             }
                          }
         }
    }
